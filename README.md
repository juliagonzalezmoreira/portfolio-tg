# Portfólio Acadêmico - Julia Gonzalez Moreira
...
**👥 Parceiro acadêmico:** FATEC São José dos Campos </br>
...
* Gestão de Tempo: Organizei as tarefas dentro do Trello, acompanhando o progresso de cada membro da equipe e garantindo que as entregas fossem feitas no prazo. Isso foi fundamental para a conclusão do projeto dentro do prazo estipulado pela FATEC.

* Colaboração: Trabalhei de forma colaborativa com os desenvolvedores para garantir que o site fosse funcional e tivesse uma boa experiência para o usuário. Durante o desenvolvimento do sistema de avaliação, ajudava a revisar o código, discutir melhorias e sugerir mudanças para otimizar a interface.

👩‍💻 **Hard Skills**

* HTML5: Uso com autonomia na construção das páginas e estruturação do conteúdo.
* CSS3: Uso com autonomia, criando layouts responsivos e adaptáveis para diferentes dispositivos.
* Bootstrap: Uso com autonomia, garantindo um design funcional e visualmente agradável.
* JavaScript: Uso com autonomia, implementando funcionalidades de interatividade, como a validação de formulários e a implementação do sistema de avaliação.
* Flask (Python): Uso com ajuda, colaborando no desenvolvimento do back-end e integração com o front-end.
* GitHub: Uso com autonomia para versionamento de código e controle de colaboração entre os membros da equipe.
* Figma: Uso com ajuda, colaborando na criação de protótipos da interface de usuário
...
|-----------------|----------------|----------------|-----------------|-----------------|----------------|
| Desenvolvimento da aplicação desktop e implementação da lógica de leitura e análise de documentos. | Gerenciamento de dependências e automação do processo de build. | Modelagem e armazenamento das interações e dados extraídos dos documentos. | Criação dos protótipos da interface, colaborando no design e experiência do usuário. | Organização do backlog e gestão de tarefas em sprints. | Controle de versão, registro de progresso e colaboração no desenvolvimento do projeto. |
